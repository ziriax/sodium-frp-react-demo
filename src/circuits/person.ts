...
export class Person {
    ...
    public readonly serializable: S.Cell<M.Identified<M.Person>>;
    ...
    private constructor(model: M.Identified<M.Person>, selected: S.Cell<MaybePerson>, loaded: S.Stream<M.Person>) {
        ...
        this.serializable = this.firstName.lift(this.lastName, (firstName, lastName) => M.Identified.from(this.modelId, { firstName, lastName}));
    }
